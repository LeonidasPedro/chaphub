    ...
    <section className="ecossistema" id="ecossistema">
      <div className="container">
        <div className="section-header fade-in">
          ...
          <p className="section-desc">Cinco Grupos de Trabalho (GTs) orbitando o hub central, criando uma rede dinâmica de inovação e colaboração.</p>
        </div>
        <div className="ecossistema__diagram fade-in">
          <svg id="ecosSvg" viewBox="0 0 700 500" xmlns="http://www.w3.org/2000/svg" className="ecos-svg">
            ...
            <text x="556" y="161" textAnchor="middle" fill="#5855A6" fontSize="9" fontFamily="sans-serif" fontWeight="bold">GT</text>
            ...
            <text x="144" y="157" textAnchor="middle" fill="#aaa" fontSize="7" fontFamily="sans-serif" fontWeight="bold">GT</text>
