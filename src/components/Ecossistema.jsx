    ...
    <section className="ecossistema" id="ecossistema">
      <div className="container">
        <div className="section-header fade-in">
          ...
          <p className="section-desc">Três Grupos de Trabalho (GTs) orbitando o hub central, criando uma rede dinâmica de inovação e colaboração.</p>
        </div>
        <div className="ecossistema__diagram fade-in">
          <svg id="ecosSvg" viewBox="0 0 700 500" xmlns="http://www.w3.org/2000/svg" className="ecos-svg">
            ...
            <line className="ecos-line" x1="350" y1="250" x2="490" y2="420" stroke="url(#lineGrad)" strokeWidth="1.5" strokeDasharray="6 3" opacity="0.6" style={{ animationDelay: '0.1s' }} />
            <line className="ecos-line" x1="350" y1="250" x2="210" y2="420" stroke="url(#lineGrad)" strokeWidth="1.5" strokeDasharray="6 3" opacity="0.6" style={{ animationDelay: '0.2s' }} />
            ...
            <text x="350" y="76" textAnchor="middle" fill="#1BBDE8" fontSize="9" fontFamily="sans-serif" fontWeight="bold">GT</text>
            ...
            <text x="488" y="414" textAnchor="middle" fill="#aaa" fontSize="8" fontFamily="sans-serif" fontWeight="bold">GT</text>
            <text x="488" y="426" textAnchor="middle" fill="#aaa" fontSize="8" fontFamily="sans-serif" fontWeight="bold">EDUCAÇÃO</text>
            <circle className="ecos-node" cx="212" cy="418" r="34" fill="#0a1a1a" stroke="#1BBDE8" strokeWidth="1.5" filter="url(#nodeGlow)" />
            <text x="212" y="414" textAnchor="middle" fill="#1BBDE8" fontSize="9" fontFamily="sans-serif" fontWeight="bold">GT</text>
        ...
        <div className="ecossistema__stats">
          <div className="ecos-stat fade-in">
            <span className="ecos-stat__num">3</span>
            <span className="ecos-stat__label">Grupos de Trabalho (GTs)</span>
          </div>
